...
This is an extended version of the breakout game with external functions listed as below:
1. Scoreboard (set up at coder file)
2. Remaining lives board (set up at coder file, update at user file)
"""

from campy.gui.events.timer import pause
from breakoutgraphics_ext_v1 import BreakoutGraphics
